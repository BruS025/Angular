...
var SpotifyService = /** @class */ (function () {
    ...
    SpotifyService.prototype.getNewReleases = function () {
        ...
        return this._http.get('https://api.spotify.com/v1/browse/new-releases', { headers: header }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (respuesta) { respuesta['albums'].items; }));
    };
    SpotifyService.prototype.getArtista = function (termino) {
        var header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Authorization': 'Bearer BQBeUSJQ8q37fJfz7PtOnqFlqvRexuVtid3Idl6VTQcQegLABikxDU10R5JHMnWealuMKV-T-KTy51cCh2s'
        });
        return this._http.get("https://api.spotify.com/v1/search?q=" + termino + "&type=artist", { headers: header }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (respuesta) { respuesta['artists'].items; }));
    };
...
module.exports = __webpack_require__(/*! C:\Users\Bruno\Documents\GitHub\Angular\3spotiapp\src\main.ts */"./src/main.ts");
